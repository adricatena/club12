...
export const getServerSideProps: GetServerSideProps<Props> = async (
  ...
  const sportFromDb = sportsFromDb.filter(
    (sport) => sport.name.toLowerCase() === sportFromUrl,
  )[0];
    ...
    return (
      <Layout>
        <section className="mx-auto text-center">
          ...
          <Button component={Link} href="/equipos/crear" className="mt-4">
            Volver
          </Button>
        </section>
      </Layout>
